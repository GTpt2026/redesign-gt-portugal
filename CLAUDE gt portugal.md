...
When a task involves external tools or technical elements that a non-coder wouldn't know (Sanity, Vercel, GSAP, localhost:3000, etc.):
...
- `components/` → Reusable UI pieces (layout, ui, sections)
- `app/globals.css` → All design tokens, reset, and layout styles
